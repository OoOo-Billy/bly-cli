...
async function create(options) {
  const isTestOrDebug = process.env.BLY_CLI_DEBUG === 'yes'
  ...
  async function creatingFilesAndTemplate() {
    ...
    // TODO: debug - ignore node_modules and did't track README.md in windows.
    ...
    if (hasGit()) {
      ...
      const msg =
        /**typeof preset.gitInitMessage === 'string' ? preset.gitInitMessage :*/ 'init'
      try {
